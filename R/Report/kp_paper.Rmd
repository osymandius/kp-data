...
pse_method <- read_csv("~/Imperial College London/HIV Inference Group - WP - Documents/Analytical datasets/key-populations/PSE/pse_method.csv")
...
p3 <- prev_estimates %>%
  ...
  labs(y="Prevalence ratio", x="Age/sex matched total\npopulation HIV prevalence") +
  theme(panel.border = element_rect(fill=NA, color="black")) +
  facet_wrap(~kp, ncol=1)
